...
func modelManagementDB(t *testing.T, kind, dsn string) *gorm.DB {
	...
	require.NoError(t, database.AutoMigrate(&model.Model{}, &model.Vendor{}, &model.Channel{}, &model.ChannelCredential{}, &model.ChannelCredentialRevision{}, &model.Ability{}, &model.Option{}, &model.User{}, &model.AuditLog{}))

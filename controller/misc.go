...
func SendEmailVerification(c *gin.Context) {
	...
	subject, title, content := buildEmailVerificationMessage(lang, code)
	err := common.SendEmail(subject, email, service.RenderBrandedEmail(lang, title, content))
	if err != nil {
...
func buildEmailVerificationMessage(lang string, code string) (subject string, title string, content htmltemplate.HTML) {
	subject = i18n.Translate(lang, i18n.MsgEmailVerificationSubject, map[string]any{
		"SystemName": common.SystemName,
	})
	title = i18n.Translate(lang, i18n.MsgEmailVerificationTitle)
	content = i18n.TranslateHTML(lang, i18n.MsgEmailVerificationBody, map[string]any{
		"SystemName": common.SystemName,
		"Code":       code,
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if user, err := model.GetUniqueUserByEmail(email); err == nil {
		...
		title := i18n.Translate(lang, i18n.MsgEmailPasswordResetTitle)
		content := i18n.TranslateHTML(lang, i18n.MsgEmailPasswordResetBody, map[string]any{
			"SystemName": common.SystemName,
			"Link":       link,
			"Minutes":    common.VerificationValidMinutes,
		})

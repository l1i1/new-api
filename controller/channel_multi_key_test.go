...
func TestMultiKeyEnableRestoresOnlyExhaustedChannels(t *testing.T) {
	...
	require.NoError(t, database.AutoMigrate(&model.Channel{}, &model.ChannelCredential{}, &model.ChannelCredentialRevision{}, &model.Ability{}, &model.User{}, &model.Log{}, &model.AuditLog{}))

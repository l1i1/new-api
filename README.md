...
| `CORS_ALLOWED_ORIGINS` | Exact comma-separated Origins allowed for relay/dashboard CORS; blank keeps the legacy allow-all behavior; separate from `SESSION_COOKIE_TRUSTED_URL` | allow-all |

...
export function ModelMutateDrawer({
  ...
  const modelSettings = useMemo(() => {
    ...
    const defaultModelSettings: ModelSettings = {
      ...
      'global.mask_upstream_model_name': false,
      ...
      'monitor_setting.multi_key_test_enabled': false,
      'monitor_setting.multi_key_test_minutes': 60,
      'monitor_setting.multi_key_test_channels': '',
      'monitor_setting.multi_key_test_model': '',
      'monitor_setting.multi_key_test_reenable_manual': false,

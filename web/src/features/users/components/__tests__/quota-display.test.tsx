...
it('keeps the local USD preference when the server config uses custom currency', () => {
...
it('uses the explicit local CNY preference with the configured exchange rate', () => {
...
it('keeps the local USD preference when the server config uses tokens mode', () => {
  useSystemConfigStore.getState().setConfig({

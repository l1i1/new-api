...
describe('Tokeness legacy home', () => {
  ...
  test('keeps the server-rendered head placeholder in the HTML template', () => {
    const html = readFileSync(
      new URL('../../../../../index.html', import.meta.url),
      'utf8'
    )

    // The generator meta now ships inside the Go default head constant and is
    // guarded by router/web_router_head_test.go.

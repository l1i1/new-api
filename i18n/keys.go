...
const (
	...
	MsgInvoicePaymentMethodNotAllowed = "invoice.payment_method_not_allowed"
	...
	MsgInvoiceInsufficientBalance     = "invoice.insufficient_balance"
	MsgInvoiceKindInvalid             = "invoice.kind_invalid"
	MsgInvoiceSpecialRequiresOrg      = "invoice.special_requires_organization"
	MsgInvoiceSpecialRequiresFullInfo = "invoice.special_requires_full_info"

...
func RelaySwapFace(c *gin.Context, info *relaycommon.RelayInfo) *dto.MidjourneyResponse {
	...
	if billingApplied {
		...
		model.RecordConsumeLog(c, info.UserId, model.RecordConsumeLogParams{ChannelId: billingChannelID, ModelName: modelName, TokenName: tokenName, Quota: midjourneyTask.Quota, Content: logContent, TokenId: midjourneyTask.TokenId, Group: info.UsingGroup, Other: other})
...
func RelayMidjourneySubmit(c *gin.Context, relayInfo *relaycommon.RelayInfo) *dto.MidjourneyResponse {
	...
	if billingApplied {
		...
		model.RecordConsumeLog(c, relayInfo.UserId, model.RecordConsumeLogParams{ChannelId: billingChannelID, ModelName: modelName, TokenName: tokenName, Quota: midjourneyTask.Quota, Content: logContent, TokenId: midjourneyTask.TokenId, Group: relayInfo.UsingGroup, Other: other})
